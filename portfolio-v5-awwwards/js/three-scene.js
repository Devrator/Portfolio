...
const ThreeScene = (() => {
  ...
  /* ═══════════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════════ */
  const LAYERS = [
    { count: 5,  radius: 1.2, z: -2.2, color: new THREE.Color('#FF3CAC') },
    { count: 9,  radius: 2.0, z: -0.8, color: new THREE.Color('#A855F7') },
    { count: 9,  radius: 2.0, z:  0.8, color: new THREE.Color('#784BA0') },
    { count: 5,  radius: 1.2, z:  2.2, color: new THREE.Color('#2B86C5') },
  ];
